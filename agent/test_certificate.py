...
class TestCertificate(unittest.TestCase):
    ...
    def test_create_self_signed_certificate_existing_file(self):
        key = f"{self.testing_dir}/{self.testing_key}"
        crt = f"{self.testing_dir}/{self.testing_crt}"
    ...
    def setup_key_crt(self):
        ...
        self.testing_key = f"{testing_file_base}.key"
        self.testing_crt = f"{testing_file_base}.crt"
